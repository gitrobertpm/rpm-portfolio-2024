<template>
  <svg width="100%" height="100%" viewBox="0 0 43 43" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
    <g transform="matrix(1,0,0,1,-729.636,-429.525)">
      <g>
        <g transform="matrix(1,0,0,1,145.708,-4.77371)">
        ...
        <g transform="matrix(0.835906,0,0,0.835906,387.08,-483.08)">
    ...
    <defs>
      <linearGradient x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(0.396838,38.091,-38.091,0.396838,605.09,436.745)"><stop offset="0" style="stop-color:white;stop-opacity:0.99"/><stop offset="0.5" style="stop-color:rgb(135,135,135);stop-opacity:0"/><stop offset="1" style="stop-color:black;stop-opacity:0.75"/></linearGradient>
    </defs>
  </svg>
</template>
